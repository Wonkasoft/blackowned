...
<div id="wvm_pricr" class="wvm_plans wvm_<?php echo count($posts_array); ?>_plans wvm_style_basic">
    <div class="">
        ...
        <div class="wvm_plan wvm_plan_<?php echo $index; ?><?php if (get_post_meta($postdata->ID, 'mark_as_recommended', true) && $recomended_count==0) { echo ' wvm_recommended_plan'; } ?>">
                ...
                <?php endif; ?>
                <div class="wvm_title wvm_title_<?php echo $index; ?>" style="background: <?php echo get_wcmp_vendor_settings('_plan_header_color', 'membership', 'plan_design', '#000000'); ?>; color: <?php echo get_wcmp_vendor_settings('_plan_header_text_color', 'membership', 'plan_design', '#000000'); ?>"><?php echo $postdata->post_title; ?>
                </div>
                <div class="wvm_head wvm_head_<?php echo $index; ?>" style="background: <?php echo get_wcmp_vendor_settings('_plan_header_body_color', 'membership', 'plan_design', '#000000'); ?>">
